...
class DatabaseHelper {
  ...
  Future<int> insertLike(int userId, String photoId) async {
    Database db = await database;
    return await db.insert('likes', {'user_id': userId, 'photo_id': photoId});
  }
  ...
  Future<bool> isPhotoLikedByUser(int userId, String photoId) async {
    Database db = await database;
