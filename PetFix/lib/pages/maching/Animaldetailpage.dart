...
class _AnimalDetailPageState extends State<AnimalDetailPage> {
  ...
  Future<void> _toggleLike() async {
    if (_liked) {
      await DatabaseHelper().deleteLike(1, widget.animal['id']);
      setState(() {
        likedAnimals.removeWhere((animal) => animal['id'] == widget.animal['id']);
        _liked = false;
      });
    } else {
      await DatabaseHelper().insertLike(1, widget.animal['id']);
      setState(() {
        likedAnimals.add(widget.animal);
        _liked = true;
      });
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 16),
                              Text(
                                'Animal Type: ${widget.animal['animal_type']}',
                                style: TextStyle(
                                  fontSize: 18,
                                  color: Colors.black,
                                ),
